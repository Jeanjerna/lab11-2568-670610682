...
export default function ModalRegister() {
  ...
  const registerBtnOnClick = () => {
    ...
    if (fnameOk && lnameOk && genderOk && planOk && isUserAgreed) {
      alert(
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <div>
              <input className="me-2 form-check-input" type="checkbox" onChange={cbUserAgreedOnChange} checked={isUserAgreed}/>I agree
